...
<div align="center">
  <table width="791" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td height="5">&nbsp;</td>
      <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#39ACE6"  class="style1">
        <!--DWLayoutTable-->
        <tr>
        ...
        <tr>
          ...
          <td>:</td>
          <td colspan="3" align="left" valign="top"><?php echo '<font size="3">'.'From '.$row[9].' to '.$row[10]?></td>
