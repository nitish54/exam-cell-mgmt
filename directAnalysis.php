  ...
  <table width="750" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
     ...
     <tr>
      ...
      <td colspan="11" align="left"><span class="style5"><font color="blue">**Note: Enter Correct Entries to Analyze Previous Uploaded Record</span> </td>
      <td> </td>
      <td height="105"></td>
     </tr>
    <tr>
      ...
      <td colspan="2" rowspan="2" valign="top">
          <form id="form1" name="form1" method="post" action="Analysis.php" onsubmit="return loadSubmit();" enctype="multipart/form-data">
        <select name="year">
